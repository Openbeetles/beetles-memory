...
pub struct ProfileCapabilityCatalogEntry {
    ...
    pub compact_runtime_skill_recall_allowed: bool,
    pub dynamic_state_recall_allowed: bool,
    pub historical_as_of_recall_allowed: bool,
    pub procedural_recall_allowed: bool,
    pub environment_premise_evaluation_allowed: bool,
    pub update_lineage_inspection_allowed: bool,
...
const PROFILE_CAPABILITY_CATALOG: [ProfileCapabilityCatalogEntry; 11] = [
    ProfileCapabilityCatalogEntry {
        ...
        compact_runtime_skill_recall_allowed: true,
        dynamic_state_recall_allowed: true,
        historical_as_of_recall_allowed: false,
        procedural_recall_allowed: true,
        environment_premise_evaluation_allowed: true,
        update_lineage_inspection_allowed: false,
