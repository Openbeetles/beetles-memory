...
use bm_sdk::{
    ...
    AgentToolExperienceOwnerLocatorV3, AgentToolExperienceOwningScopeV1, AgentToolHint,
    AgentToolProjectionAudit, AgentToolRegistryRef, AgentToolRegistryReport,
    AgentToolRegistrySnapshot, AgentToolUsageFeedbackV3, ConversationKey, DerivedMemoryPlane,
    ...
    MemoryProceduralLearningStateReport, MemoryProceduralSubmissionCapability, MemoryProfile,
    MemoryProjectionOutput, MemoryProjectionReport, MemoryProjectionSafeAuditReport, MemoryRuntime,
    ...
    MemoryWriteRequest, PostReplyMemoryMaintenanceContext, PostTurnLearningEvidenceV2,
    PostTurnLearningInputV2, PrivateMaterialRedactionReport, ProceduralApplicabilityContextV1,
    ProceduralFeedbackAuthorityV2, ProceduralLearningErrorKeyV1, ProceduralLearningSdkError,
    ...
    SubjectScopedRuntime, ToolExecutionFactV1, TranscriptCatalogLifecycle, TranscriptEvidenceRef,
...
fn sdk_agent_tool_contract_types_are_importable(
    ...
    _observation: Option<ToolExecutionFactV1>,
    _feedback: Option<AgentToolUsageFeedbackV3>,
) {
    assert_eq!(
...
fn pfi1_procedural_learning_contract_types_are_importable(
    ...
    _locator: Option<AgentToolExperienceOwnerLocatorV3>,
    ...
    _input: Option<PostTurnLearningInputV2>,
    _input_authority: Option<MemoryProceduralSubmissionCapability>,
    _intent_report: Option<MemoryProceduralLearningIntentReport>,
    _evidence: Option<PostTurnLearningEvidenceV2>,
    _authority: Option<ProceduralFeedbackAuthorityV2>,
