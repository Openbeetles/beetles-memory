...
The 0.6.0 source candidate preserves CTQ1 InMemory/File/SQLite atomic head/catalog/time/search closure and persistent reopen under Store v12. Store v11 has no compatibility reader or migration path; older development data must be explicitly recreated. Repair/archive closure, private-authority exact-zero, and strict regression evidence remain required. This does not claim real-data handling, crates.io or hosted Release publication, or runtime/UAT execution.
