...
export const copy = {
  "zh-CN": {
    ...
    llmGatewayPanel: {
      ...
      noOutput: "无输出",
      protocolDetails: {
        "openai-compatible": "Models、chat completions、responses、embeddings 与 provider capability report",
        "ollama-native": "Native tags、version、chat、generate、embeddings 和 show 透传",
        "mcp-streamable-http": "显式召回、投影预览、检查与受治理写入候选",
      },
  ...
  en: {
    ...
    llmGatewayPanel: {
      ...
      noOutput: "No output",
      protocolDetails: {
        "openai-compatible": "Models, chat completions, responses, embeddings, and provider capability report",
        "ollama-native": "Native tags, version, chat, generate, embeddings, and show passthrough",
        "mcp-streamable-http": "Explicit recall, projection preview, inspection, and governed write candidates",
      },
